...
###############################################################
	...
	$settings = array(
		'consumer_key' => "Qy3IauXreqwwAF9K0Uhsg",
		'consumer_secret' => "66vXoaZe1LxD7HhwgLlxWHEhmWEtwAv5hICrD62hHo",
		'oauth_access_token' => "38512888-NEKLbQBWIacTzCK42Eg39SjFjqkMZI8a0T71jwH8w",
		'oauth_access_token_secret' => "t3UfPaCjGS9LB18W0SNBlqce0wJyrkdxveVjRWt5QCltT"
	);
...
?>
		...
		<li id="<?php echo 'tweetid-' . $id; ?>" class="tweet<?php
			...
			<div class="tweet-actions">
				<a class="action-reply" target="_blank" href="<?php echo $replyURL; ?>"><span class="glyphicon glyphicon-share-alt"></span></a>
				<a class="action-retweet" target="_blank" href="<?php echo $retweetURL; ?>"><span class="glyphicon glyphicon-retweet"></span></a>
				<a class="action-favorite" target="_blank" href="<?php echo $favoriteURL; ?>"><span class="glyphicon glyphicon-star"></span></a>
			</div>
		</li>
